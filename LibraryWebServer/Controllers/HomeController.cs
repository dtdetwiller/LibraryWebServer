...
namespace LibraryWebServer.Controllers
{
  public class HomeController : Controller
  {
    ...
    public IActionResult CheckLogin(string name, int cardnum)
    {
      ...
      using (Team84LibraryContext db = new Team84LibraryContext())
      {
    ...
    public ActionResult AllTitles()
    {
      ...
      using (Team84LibraryContext db = new Team84LibraryContext())
      {
        var query = from t in db.Titles
                    ...
                    join p in db.Patrons on j2.CardNum equals p.CardNum into ptrns
                    from j3 in ptrns.DefaultIfEmpty()
                    select new
                    {
                      isbn = t.Isbn,
                      title = t.Title,
    ...
    public ActionResult ListMyBooks()
    {
      ...
      using (Team84LibraryContext db = new Team84LibraryContext())
      {
        var query = from c in db.CheckedOut
                    ...
                    from j1 in inv.DefaultIfEmpty()
                    join t in db.Titles on j1.Isbn equals t.Isbn into ttls
                    from j2 in ttls.DefaultIfEmpty()
