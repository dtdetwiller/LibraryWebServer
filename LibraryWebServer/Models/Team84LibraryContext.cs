...
{
    public partial class Team84LibraryContext : DbContext
    {
        public Team84LibraryContext()
        {
        }

        public Team84LibraryContext(DbContextOptions<Team84LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1148322;Password=password;Database=Team84Library");
            }
        }
